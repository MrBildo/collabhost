...
public record RestartCommand(string ExternalId) : ICommand<AppDetailResponse>;

#pragma warning disable MA0051 // Long method justified — bridge restart orchestration with full response
public sealed class RestartCommandHandler
(

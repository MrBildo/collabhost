...
public class AppTypeCapabilityMapping : IEntityTypeConfiguration<AppTypeCapability>
{
    ...
    private static void SeedData(EntityTypeBuilder<AppTypeCapability> builder)
    {
        ...
        (
            ...
            AppTypeCapability.CreateSeeded(new Guid("41b486b0-037f-44e8-9a96-028c490fa48c"), IdentifierCatalog.AppTypes.DotNetApp, IdentifierCatalog.Capabilities.Routing, """{"domainPattern":"{slug}.collab.internal","serveMode":"reverse-proxy"}"""),
        ...
        (
            ...
            AppTypeCapability.CreateSeeded(new Guid("74137008-620c-46cc-ba2c-e1e1896d25c1"), IdentifierCatalog.AppTypes.NodeApp, IdentifierCatalog.Capabilities.Routing, """{"domainPattern":"{slug}.collab.internal","serveMode":"reverse-proxy"}"""),

...
namespace Collabhost.Api.Migrations
{
    ...
    [Migration("20260401152252_AddArtifactCapability")]
    partial class AddArtifactCapability
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Collabhost.Api.Domain.Entities.AppTypeCapability", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("57b55f26-c099-4b2f-ba7b-04678331417f"),
                            AppTypeId = new Guid("d3333aba-642e-4784-a501-856a25ae6fe5"),
                            CapabilityId = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                        ...
                        new
                        {
                            Id = new Guid("21565387-1774-4a67-acac-906b7f88c0ca"),
                            AppTypeId = new Guid("49d21824-f9e6-4a44-9b12-130f8c680cb9"),
                            CapabilityId = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                            Configuration = "{\"location\":\"\"}"
                        },
                        ...
                        new
                        {
                            Id = new Guid("1884ba18-d094-4381-87eb-38d1b1209c1b"),
                            AppTypeId = new Guid("bf5105c8-6a99-414c-96b6-c74aab5471f7"),
                            CapabilityId = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                            Configuration = "{\"location\":\"\"}"
                        },
                        ...
                        new
                        {
                            Id = new Guid("ce8aba78-b73a-4e29-bae4-cc2bfd5a4cde"),
                            AppTypeId = new Guid("73e28a95-764f-4ae5-9c2b-a9fdea66c348"),
                            CapabilityId = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                            Configuration = "{\"location\":\"\"}"
                        },
                        ...
                        new
                        {
                            Id = new Guid("a040791b-319e-46d6-8c58-55f5ace69827"),
                            AppTypeId = new Guid("606cdf1f-f41e-42d2-bb13-04b598de0f63"),
                            CapabilityId = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                            Configuration = "{\"location\":\"\"}"
                        },
                        ...
                        new
                        {
                            Id = new Guid("b280d836-1434-4906-9775-3afa718b52ef"),
                            AppTypeId = new Guid("56608f77-aa9d-44b7-a3cb-df7c361d8fb8"),
                            CapabilityId = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                            Configuration = "{\"location\":\"\"}"
                        });
            ...
            modelBuilder.Entity("Collabhost.Api.Domain.Entities.Capability", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("cdd957fc-0402-45fe-9a37-788545a2ea91"),
                            Category = "behavioral",
                            Description = "Where the app's files are located on the host filesystem",
